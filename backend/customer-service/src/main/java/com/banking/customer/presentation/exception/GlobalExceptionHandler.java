...
import com.banking.customer.domain.exception.CustomerDomainException;
...
import com.banking.customer.infrastructure.util.MessageUtils;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleCustomerNotFound(
        ...
        log.warn("Customer not found - ErrorCode: {}, Parameters: {}",
    ...
    public ResponseEntity<ApiErrorResponse> handleDuplicateCustomer(
        ...
        log.warn("Duplicate customer detected - ErrorCode: {}, Parameters: {}",
                ex.getErrorCode(), ex.getParameters());
    ...
    public ResponseEntity<ApiErrorResponse> handleCustomerDomainException(
            CustomerDomainException ex,
            HttpServletRequest request) {

        log.error("Unhandled domain exception - ErrorCode: {}, Parameters: {}",
    ...
    private String resolveMessage(CustomerDomainException ex) {
